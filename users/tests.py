...
class SetupTestUser(TestCase):
    ...
    def setUp(self):
        ...
        self.update_pk1_url = reverse_lazy('user_update', kwargs={"pk": 1})
        self.delete_pk1_url = reverse_lazy("user_delete", kwargs={"pk": 1})
        self.delete_pk3_url = reverse_lazy("user_delete", kwargs={"pk": 3})
